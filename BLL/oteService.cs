...
public class LoteService : ILoteService
{
    ...
    public ResultadoOperacion ObtenerPorId(int id)
    {
        try
        {
            ...
            var lote = _loteRepository.ObtenerPorId(id);
    ...
    public ResultadoOperacion ObtenerPorProducto(int productoId)
    {
        try
        {
            ...
            var lotes = _loteRepository.ObtenerPorProducto(productoId).ToList();
    ...
    public ResultadoOperacion ObtenerTodosActivos()
    {
        try
        {
            var lotes = _loteRepository.ObtenerTodosActivos().ToList();
    ...
    public ResultadoOperacion InsertarLote(Lote lote)
    {
        try
        {
            ...
            var producto = _productoRepository.ObtenerPorId(lote.ProductoId);
            if (producto is null)
                return ResultadoOperacion.Fallo(
            ...
            var lotesExistentes = _loteRepository
    ...
    public ResultadoOperacion ActualizarStock(int loteId, int cantidad, EstadoLote estado)
    {
        try
        {
            ...
            var lote = _loteRepository.ObtenerPorId(loteId);
            if (lote is null)
                return ResultadoOperacion.Fallo(
            ...
            _loteRepository.ActualizarStock(loteId, cantidad, estadoFinal);
