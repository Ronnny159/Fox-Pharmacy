...
public class BIService : IBIService
{
    ...
    public ResultadoOperacion ObtenerTopProductos(int top = 10, string orden = "MAYOR")
    {
        try
        {
            ...
            var detallesPorProducto = ventas
                .SelectMany(v => _detalleVentaRepository.ObtenerPorVenta(v.Id))
            ...
            {
                var producto = _productoRepository.ObtenerPorId(r.ProductoId);
                return new
                {
                    r.ProductoId,
    ...
    public ResultadoOperacion ObtenerProductosPorVencer(int dias = 30)
    {
        try
        {
            ...
            {
                var producto = _productoRepository.ObtenerPorId(l.ProductoId);
    ...
    public ResultadoOperacion ObtenerResumenInventario()
    {
        try
        {
            var todosLosLotes = _loteRepository.ObtenerTodosActivos().ToList();
            var todosProductos = _productoRepository.ObtenerTodos().ToList();
