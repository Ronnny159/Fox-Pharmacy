...
public class ClienteService : IClienteService
{
    ...
    public ResultadoOperacion ObtenerPorDocumento(string documento)
    {
        try
        {
            ...
            var cliente = _clienteRepository.ObtenerPorDocumento(documento.Trim());
    ...
    public ResultadoOperacion ObtenerTodosFidelizacion()
    {
        try
        {
            var clientes = _clienteRepository.ObtenerTodosFidelizacion().ToList();
    ...
    public ResultadoOperacion Insertar(Cliente cliente)
    {
        try
        {
            ...
            var existente = _clienteRepository.ObtenerPorDocumento(cliente.Documento.Trim());
    ...
    public ResultadoOperacion VincularTelegram(string documento, string chatId)
    {
        try
        {
            ...
            var clienteConChatId = _clienteRepository.ObtenerPorChatId(chatId.Trim());
