...
public class AuditoriaService : IAuditoriaService
{
    ...
    private readonly IAjusteInventarioRepository _ajusteInventarioRepository;
        ...
        IAjusteInventarioRepository ajusteInventarioRepository)
    {
        ...
        _ajusteInventarioRepository = ajusteInventarioRepository;
    }
    ...
    public ResultadoOperacion ObtenerHistorialParametros(string clave)
    {
        try
        {
            ...
            var historial = _historialParametroRepository.ObtenerPorParametro(clave.Trim().ToUpper());
    ...
    public ResultadoOperacion ObtenerHistorialDescuentosProducto(int productoId)
    {
        try
        {
            ...
            var historial = _historialDescuentoRepository.ObtenerPorProducto(productoId);
    ...
    public ResultadoOperacion ObtenerResumenAuditoria()
    {
        try
        {
            ...
            var totalParametros = _historialParametroRepository
                .ObtenerPorRangoFechas(desde, hoy);

            // Historial completo de descuentos
            var totalDescuentos = _historialDescuentoRepository
                .ObtenerTodos();

            // Ajustes de inventario en los últimos 30 días
            var ajustesRecientes = _ajusteInventarioRepository
                .ObtenerPorRangoFechas(desde, hoy)
                .ToList();
